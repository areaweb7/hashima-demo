...
if __name__ == "__main__":
    ...
    ARTICLE_FILE = os.path.join(script_dir, "ブログ/0930/0903　２名のベトナム技能実習生入社/article.md")
    IMG_FEAT = os.path.join(script_dir, "ブログ/0930/0903　２名のベトナム技能実習生入社/画像 (3).jpg")
    IMG_IN_1 = os.path.join(script_dir, "ブログ/0930/0903　２名のベトナム技能実習生入社/chubu-daiichi-technical-intern-tran-thi-hoai.jpg")
    IMG_IN_2 = os.path.join(script_dir, "ブログ/0930/0903　２名のベトナム技能実習生入社/chubu-daiichi-technical-intern-chinh-thi-huong.jpg")
    CATEGORY_ID = 6
    ...
    seo_settings = {
        ...
        "slug": f"welcome-vietnam-technical-interns-{slug_date}",
        "keywords": "技能実習生, ベトナム, 中部第一グループ, 入社" # キーワードを追加
    }
    alt_texts = {
        IMG_FEAT: "中部第一グループに入社したベトナムからの技能実習生2名",
        IMG_IN_1: "ベトナムから中部第一グループに入社した、技能実習生のチャン・ティ・ホアイさん",
        IMG_IN_2: "ベトナムから中部第一グループに入社した、技能実習生のチン・ティ・フォンさん"
    }
...
"""
    ...
    if featured_media_object:
        final_html = final_html.replace("<!-- image_placeholder_1 -->", create_image_block(featured_media_object, alt_texts[IMG_FEAT]))
    ...
    previous_slug = f"welcome-vietnam-technical-interns-{datetime.now().strftime(%Y%m%d)}"
